...
@Composable
fun HomeScreen(articles: LazyPagingItems<Article>, navController: (String) -> Unit) {
    ...
    Column(
        ...
        SearchBar(
            ...
            onSearch = {},
            onClick = {
                navController(Route.SearchScreen.route)
            }
        )
        ...
        ArticleList(
            ...
            articles = articles,
            onClick = {
                navController(Route.DetailsScreen.route)
            }
        )
    }
}
